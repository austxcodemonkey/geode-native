...
//  public:
//   TcpSslConn(const char* hostname, int32_t port, std::chrono::microseconds
//   wait,
//              int32_t maxBuffSizePool, const char* pubkeyfile,
//              const char* privkeyfile, const char* pemPassword)
//       : TcpConn(hostname, port, wait, maxBuffSizePool),
//         m_ssl(nullptr),
//         m_pubkeyfile(pubkeyfile),
//         m_privkeyfile(privkeyfile),
//         m_pemPassword(pemPassword){};

//   TcpSslConn(const char* ipaddr, std::chrono::microseconds wait,
//              int32_t maxBuffSizePool, const char* pubkeyfile,
//              const char* privkeyfile, const char* pemPassword)
//       : TcpConn(ipaddr, wait, maxBuffSizePool),
//         m_ssl(nullptr),
//         m_pubkeyfile(pubkeyfile),
//         m_privkeyfile(privkeyfile),
//         m_pemPassword(pemPassword){};
