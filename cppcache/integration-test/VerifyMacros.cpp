...
void initClient(const bool isthinClient,
  ...
  if (cacheHelper == nullptr) {
    cacheHelper =
        new apache::geode::client::CacheHelper(isthinClient, configPtr);
  }
...
void initClient(const bool isThinClient, const bool redirectLog) {
  if (cacheHelper == nullptr) {
    ...
    if (redirectLog) {
      config->insert("log-file",
                     apache::geode::client::CacheHelper::unitTestOutputFile());
    }
...
void createPooledRegion(const char* name, bool ackMode, const char* locators,
  ...
  auto regPtr =
      getHelper()->createPooledRegion(name, ackMode, locators, poolname,
                                      cachingEnabled, clientNotificationEnabled);
...
std::shared_ptr<apache::geode::client::Region> createPooledRegion(
  ...
  if (cacheHelper == nullptr) {
    cacheHelper = new apache::geode::client::CacheHelper(true, poolname,
                                                         locators, nullptr);
  }
